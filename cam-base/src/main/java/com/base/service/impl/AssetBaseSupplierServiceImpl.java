...
import com.base.dao.AssetBaseSupplierDAO;
import com.base.service.DataBaseService;

public class AssetBaseSupplierServiceImpl extends BaseService implements DataBaseService {
	...
	public int save(Map<String, Object> map) {
		...
		if (checkMap(map)) {
			...
			try {
				...
				AssetBaseSupplierDAO mapper = sqlSession.getMapper(AssetBaseSupplierDAO.class);
				result = mapper.save(map);
				if (result > 0 && map.get("supplierId") != null) {
					result = Integer.parseInt(map.get("supplierId").toString());
				}
			} catch (IOException e) {
