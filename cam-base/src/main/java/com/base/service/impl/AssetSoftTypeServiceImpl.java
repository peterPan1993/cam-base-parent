...
import com.base.dao.AssetSoftTypeDAO;
import com.base.service.DataBaseService;

public class AssetSoftTypeServiceImpl extends BaseService implements DataBaseService {
	...
	public int save(Map<String, Object> map) {
		...
		if (checkMap(map)) {
			...
			try {
				...
				AssetSoftTypeDAO mapper = sqlSession.getMapper(AssetSoftTypeDAO.class);
				result = mapper.save(map);
				if (result > 0 && map.get("softwareTypeId") != null) {
					result = Integer.parseInt(map.get("softwareTypeId").toString());
				}
			} catch (IOException e) {
