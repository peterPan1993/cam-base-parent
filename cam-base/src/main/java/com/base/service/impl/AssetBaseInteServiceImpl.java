...
import com.base.dao.AssetBaseInteDAO;
import com.base.service.DataBaseService;

public class AssetBaseInteServiceImpl extends BaseService implements DataBaseService {
		...
		if (checkBaseMap(map) && checkMap(map)) {
			...
			try {
				...
				if (result > 0 && map.get("assetId") != null) {
					AssetBaseInteDAO mapper = sqlSession.getMapper(AssetBaseInteDAO.class);
