...
import com.base.dao.AssetBaseFixedDAO;
import com.base.service.DataBaseService;

public class AssetBaseFixedServiceImpl extends BaseService implements DataBaseService {
		...
		if (checkBaseMap(map) && checkMap(map)) {
			...
			try {
				...
				if (result > 0 && map.get("assetId") != null) {
					AssetBaseFixedDAO mapper = sqlSession.getMapper(AssetBaseFixedDAO.class);
