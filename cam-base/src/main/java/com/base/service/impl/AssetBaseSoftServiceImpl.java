...
import com.base.dao.AssetBaseSoftDAO;
import com.base.service.DataBaseService;

public class AssetBaseSoftServiceImpl extends BaseService implements DataBaseService {
		...
		if (checkBaseMap(map) && checkMap(map)) {
			...
			try {
				...
				if (result > 0 && map.get("assetId") != null) {
					AssetBaseSoftDAO mapper = sqlSession.getMapper(AssetBaseSoftDAO.class);
