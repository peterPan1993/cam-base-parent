...
import com.base.dao.AssetSoftModeDAO;
import com.base.service.DataBaseService;

public class AssetSoftModeServiceImpl extends BaseService implements DataBaseService {
	...
	public int save(Map<String, Object> map) {
		...
		if (checkMap(map)) {
			...
			try {
				...
				AssetSoftModeDAO mapper = sqlSession.getMapper(AssetSoftModeDAO.class);
				result = mapper.save(map);
				if (result > 0 && map.get("modeId") != null) {
					result = Integer.parseInt(map.get("modeId").toString());
				}
			} catch (IOException e) {
