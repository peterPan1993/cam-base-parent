...
import com.base.dao.AssetBaseTypeDAO;
import com.base.service.DataBaseService;

public class AssetBaseTypeServiceImpl extends BaseService implements DataBaseService {
	...
	public int save(Map<String, Object> map) {
		...
		if (checkMap(map)) {
			...
			try {
				...
				AssetBaseTypeDAO mapper = sqlSession.getMapper(AssetBaseTypeDAO.class);
				result = mapper.save(map);
				if (result > 0 && map.get("typeId") != null) {
					result = Integer.parseInt(map.get("typeId").toString());
				}
			} catch (IOException e) {
